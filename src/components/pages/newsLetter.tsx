        ...
        <div className="mt-10 w-full max-w-lg">
          ...
          <div className="mt-6 flex flex-wrap justify-center items-center gap-x-6 gap-y-2 opacity-60">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] md:text-xs text-primary-200 uppercase tracking-wider family-medium">BIS Insights</span>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4 text-secondary-500" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
              </svg>
              <span className="text-[11px] md:text-xs text-primary-200 uppercase tracking-wider family-medium">Zero Spam</span>
            </div>
          </div>
        </div>
