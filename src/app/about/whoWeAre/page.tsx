...
const AboutUsSection = () => {
  ...
  return (
    <>
      <Heading
  label="About Us"
  title="Trusted BIS Compliance Experts"
  description="Reliable certification and regulatory support."
/>
        ...
        >
          ...
          >
            <div className="relative w-full max-w-[540px]">
              ...
              >
                ...
                <div>
                  <div className="text-xl family-bold text-primary-800 leading-none">10+</div>
                  <div className="text-[9px] family-semibold uppercase tracking-wider text-primary-400">Years Exp.</div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs family-bold uppercase tracking-widest text-secondary-200">
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            <div className="flex flex-col space-y-5 lg:space-y-6">
              ...
              >
                Complete BIS, Product Certification & <br className="hidden lg:block" />
                <span className="text-primary-500">Global Regulatory Compliance Solutions</span>
              </motion.h2>
                ...
                {[
                  {
                    ...
                    title: "Global Manufacturer Support",
                    desc: "Helping importers, exporters and overseas brands access Indian markets."
                  },
                  {
                    icon: <HiOutlineDocumentText />,
                    title: "Government Approval Management",
                    desc: "Structured documentation, audits, testing and ministry liaison under one roof."
                  }
                ].map((item, idx) => (
                ...
                <div className="flex items-center gap-3 py-2 border-l border-primary-100 pl-6 hidden sm:flex">
                  ...
                  <div className="text-[10px] family-bold text-primary-800 uppercase tracking-tighter">
                    <div className="flex items-center gap-1 text-secondary-600">
                      <BsPatchCheckFill />
                      Trusted Regulatory Advisors
                    </div>
                    <span className="text-primary-300 font-normal">India & Global Manufacturers</span>
                  </div>
                </div>
              </motion.div>
