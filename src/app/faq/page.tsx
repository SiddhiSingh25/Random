    ...
    >
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm family-semibold" style={{ color: "#20385c" }}>
            {q.question}
          </span>
        </div>
        <FaChevronDown
      ...
      >
        ...
        >
          <p className="text-sm leading-relaxed family-semibold" style={{ color: "#4a5568" }}>
            {q.answer}
          </p>
        </div>
      </div>
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-2.5">
                            ...
                            <span
                              className="text-[12.5px] family-semibold"
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="family-semibold text-xs" style={{ color: "#6b7280" }}>
              ...
              >
                ...
                <p className="family-semibold text-xs mb-4" style={{ color: "rgba(210,205,195,0.65)" }}>
